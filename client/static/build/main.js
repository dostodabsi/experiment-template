...
},{"./template":2,"jquery":13,"underscore":14}],2:[function(require,module,exports){
var $     = require('jquery');
var _     = require('underscore');
...
},{"../utils":6,"jquery":13,"underscore":14}],3:[function(require,module,exports){
var _            = require('underscore');
var $            = require('jquery');
...
},{"./routers/Router":5,"./views/Debriefing":7,"./views/Experiment":8,"./views/Explanation":9,"./views/Instruction":10,"./views/Questions":11,"backbone":12,"jquery":13,"underscore":14}],4:[function(require,module,exports){
var _        = require('underscore');
var Backbone = require('backbone');
...
},{"backbone":12,"underscore":14}],5:[function(require,module,exports){
var _        = require('underscore');
var Backbone = require('backbone');
...
},{"backbone":12,"underscore":14}],6:[function(require,module,exports){
var fs = require('fs');
var $  = require('jquery');
var _  = require('underscore');
...
},{"fs":15,"jquery":13,"underscore":14}],7:[function(require,module,exports){
var fs           = require('fs');
var $            = require('jquery');
var _            = require('underscore');
var Backbone     = require('backbone');

var debriefing = "<div class=\"debriefing\">\n\t<h1 class=\"heading\">The End!</h1>\n\tI want to thank you personally for your participation and your endurance in\n\tthis experiment. I hope that you haven't had too bad a time, but if so,\n\t<a href=\"https://www.youtube.com/watch?v=0Bmhjf0rKe8\" target=\"_blank\">here</a>\n\tis a short video of a sweet kitten that will cheer you up!\n\t<p id=\"code\">Your Code: <%= number %></p>\n</div>\n";
...
},{"backbone":12,"fs":15,"jquery":13,"underscore":14}],8:[function(require,module,exports){
var fs          = require('fs');
var $           = require('jquery');
var _           = require('underscore');
var Backbone    = require('backbone');
...
var flanker  = "<div class=\"flanker-stim\">\n\t<p class=\"flanker\" style=\"color: <%= color %>\"><%= stim %></p>\n</div>\n";

var blockFeedback = "<div class=\"flanker-feedback\">\n\n\t<% if (practice) { %>\n\n\t\t<div class=\"practice\">\n\t\t\t<p>You have done very well!</p>\n\t\t\t<p>Remember to always press the central letter.</p>\n\t\t\t<p class=\"prompt\">press space bar to start the experiment</p>\n\t\t</div>\n\n\t<% } else { %>\n\n\t\t<p>Your average response time is <span><%= meanRT %> ms</span></p>\n\t\t<p>You have made <span><%= errorCount %></span> <span id=\"errors\">errors</span></p>\n\t\t<p>Can you do better?</p>\n\t\t<p class=\"prompt\">press space bar and proof it!</p>\n\t<% } %>\n\n</div>\n";
...
},{"../experiment/flanker":1,"../models/Participant":4,"backbone":12,"fs":15,"jquery":13,"underscore":14}],9:[function(require,module,exports){
var fs          = require('fs');
var $           = require('jquery');
var _           = require('underscore');
var Backbone    = require('backbone');

var explanation = "<div class=\"explanation\">\n\t<h1 class=\"heading explanation-heading\">Explanation</h1>\n\n\t</p> This is a so-called reaction time experiment, which means that\n\tyou should answer as quickly as possible. The experiment consists of trials, which in turn\n\tconsist of a short presentation of a picture, followed by a row of letters, as seen below.\n\tThe central letter is the target letter. You should always press the key that corresponds to the\n\ttarget letter In the example below, this would be <b>H</b> for the first two, and <b>S</b> for the second two.\n\t</p>\n\n\t<div class=\"target\">\n\t\t<div class=\"wide\">\n\t\t\t<p>HHHHHHH</p>\n\t\t\t<p>SSSHSSS</p>\n\t\t</div>\n\t\t<p>SSSSSSS</p>\n\t\t<p>HHHSHHH</p>\n\t</div>\n\n\t<p>\n\tIf you have pressed the right key, you get a green <span class=\"right\">O</span> as feedback.\n\tHowever, if you have pressed the wrong key or were too slow, a red <span class=\"wrong\">X</span>\n\twill appear on the screen. The Experiment consists of 3 blocks, each of which consists of 128 Trials.\n\tTaken together, this should not take more than 20 minutes.\n\t</p>\n\n\t<p>\n\tThere will be a practice trial for you the get a feeling for the experiment.\n\tTo demonstrate your understanding, please click the heading <b>Explanation</b> above to proceed\n\twith the experiment.\n\t<p>\n\n\t<div class=\"listened\" >\n\t\t<button class=\"btn-xl btn-success proceed\">Proceed</button>\n\t</div>\n</div>\n";
...
},{"backbone":12,"fs":15,"jquery":13,"underscore":14}],10:[function(require,module,exports){
var fs          = require('fs');
var $           = require('jquery');
var _           = require('underscore');
var Backbone    = require('backbone');

var instruction = "<div class=\"instruction\">\n\t<h1 class=\"heading\">Hello there!</h1>\n\n\t<div class=\"intro\">\n\t\t<p>Thank you for taking the time to participate in this experiment.\n\t\tBelow is some information that describes the nature of the experiment, \n\t\twhat to expect, and how you will be measured. Please take the time\n\t\tto read this over before deciding to participate in this experiment.</p>\n\t</div>\n\n\t<div class=\"exp\">\n\t\t<p>This is a reaction time experiment, which means you will be presented\n\t\twith a stimulus to which you should respond as quickly as possible by\n\t\tpressing a certain key. In this case, the stimulus is a row of letters, and\n\t\tthe possible responses are the letters <em>S</em> and <em>H</em>. But more\n\t\ton that later.</p>\n\t</div>\n\n\t<div class=\"legal\">\n\t\t<p>In this experiment we collect your reaction time data, as well as some information about\n\t\tyourself (sex, age, handedness). This data is used for scientific purposes only. By\n\t\tparticipating in this experiment, you give consent to the collection of your data.\n\t\t</p>\n\t</div>\n\n\t<p>\n\tIn order to be fully concentrated on the experiment, please remove all\n\tdisturbances temporarily and find a quiet place.\n\tAdditionally, please change into Full-Screen Mode by pressing F11.\n\t<p>\n\n\t<div class=\"listened\" >\n\t\t<p style=\"color: green;\">Thank you very much!</p>\n\t\t<button class=\"btn-xl btn-success agree\">Participate</button>\n\t</div>\n</div>\n";
...
},{"backbone":12,"fs":15,"jquery":13,"underscore":14}],11:[function(require,module,exports){
var fs          = require('fs');
var $           = require('jquery');
var _           = require('underscore');
var Backbone    = require('backbone');
...
var questions = "<div class=\"questions\">\n\t<form role=\"form\" class=\"create-new-participant\">\n\t\t<legend>Information</legend>\n\n\t\t<div class=\"row\">\n\t\t\t<div class=\"form-group\">\n\t\t\t\t<div class=\"col-md-4\">\n\t\t\t\t\t<label for=\"sex\">Sex</label><br>\n\t\t\t\t\t<input type=\"radio\" name=\"sex\" value=\"male\"> Male\n\t\t\t\t\t<input type=\"radio\" name=\"sex\" value=\"female\"> Female\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class=\"row\">\n\t\t\t<div class=\"form-group\">\n\t\t\t\t<div class=\"col-md-4\">\n\t\t\t\t\t<label for=\"country\">Country</label><br>\n\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"country\">\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class=\"row\">\n\t\t\t<div class=\"form-group\">\n\t\t\t\t<div class=\"col-md-4\">\n\t\t\t\t\t<label for=\"age\">Age</label><br>\n\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"age\">\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class=\"row\">\n\t\t\t<div class=\"col-md-4\">\n\t\t\t\t<input type=\"submit\" class=\"btn-xl btn-success\" value=\"Start Practice!\">\n\t\t\t</div>\n\t\t</div>\n\n\t</form>\n</div>\n";
...
},{"../models/Participant":4,"backbone":12,"fs":15,"jquery":13,"underscore":14}],12:[function(require,module,exports){
//     Backbone.js 1.1.2
