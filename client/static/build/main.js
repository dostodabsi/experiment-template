...
},{"./template":2,"jquery":12,"underscore":13}],2:[function(require,module,exports){
var $        = require('jquery');
var _        = require('underscore');
...
},{"../utils":6,"jquery":12,"underscore":13}],3:[function(require,module,exports){
var _            = require('underscore');
var $            = require('jquery');
...
},{"./routers/Router":5,"./views/Debriefing":7,"./views/Experiment":8,"./views/Instruction":9,"./views/Questions":10,"backbone":11,"jquery":12,"underscore":13}],4:[function(require,module,exports){
var _        = require('underscore');
var Backbone = require('backbone');
...
},{"backbone":11,"underscore":13}],5:[function(require,module,exports){
var _        = require('underscore');
var Backbone = require('backbone');
...
},{"backbone":11,"underscore":13}],6:[function(require,module,exports){
var fs = require('fs');
var $  = require('jquery');
var _  = require('underscore');
...
},{"fs":14,"jquery":12,"underscore":13}],7:[function(require,module,exports){
var fs           = require('fs');
var _            = require('underscore');
var $            = require('jquery');
var Backbone     = require('backbone');
...
var debriefing = "<div class=\"debriefing\">\n\tYou rock! Watch a video of sweet kittens\n\t<a href=\"https://www.youtube.com/watch?v=pLCOTpjBGcs\">here</a>\n\t<p>Here is your number: <%= number %></p>\n\t<p>Watch for it everywhere</p>\n</div>\n";
...
},{"backbone":11,"fs":14,"jquery":12,"underscore":13}],8:[function(require,module,exports){
var fs          = require('fs');
var $           = require('jquery');
var _           = require('underscore');
var Backbone    = require('backbone');
...
var flanker = "<table class=\"flanker-stim\">\n\t<tr>\n\t\t<td><%= outer %></td>\n\t\t<td><%= outer %></td>\n\t\t<td><%= inner %></td>\n\t\t<td><%= outer %></td>\n\t\t<td><%= outer %></td>\n\t</tr>\n</table>\n";
var fixCross = "<table class=\"flanker-stim\">\n\t<tr class=\"otherFeedback\">\n\t\t<td>S</td>\n\t\t<td>H</td>\n\t\t<td class=\"feedback\"><%= feedback %></td>\n\t\t<td>H</td>\n\t\t<td>S</td>\n\t</tr>\n</table>\n";
var feedback = "<p class=\"flanker-stim\">\nYou're mean Reaction Time is <span><%= mean %> ms</span>\nYou're error count is <span><%= mean %></span>\n<br>\nCan you do better?\n<h2>Press Space Bar and show me!</h2>\n</p>\n";
...
},{"../experiment/flanker":1,"../models/Participant":4,"backbone":11,"fs":14,"jquery":12,"underscore":13}],9:[function(require,module,exports){
var fs           = require('fs');
var _            = require('underscore');
var $            = require('jquery');
var Backbone     = require('backbone');
...
},{"backbone":11,"fs":14,"jquery":12,"underscore":13}],10:[function(require,module,exports){
var fs           = require('fs');
var _            = require('underscore');
var $            = require('jquery');
var Backbone     = require('backbone');
...
},{"../models/Participant":4,"backbone":11,"fs":14,"jquery":12,"underscore":13}],11:[function(require,module,exports){
//     Backbone.js 1.1.2
